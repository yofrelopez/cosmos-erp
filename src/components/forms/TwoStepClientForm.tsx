...
export function TwoStepClientForm({ onSuccess, initialData, searchTerm, isInModal = false }: Props) {
  ...
  return (
    ...
    >
      ...
      {currentStep === 1 && (
        <div key="step-1-content" className="space-y-4">
      ...
      {currentStep === 2 && (
        <div key="step-2-content" className="space-y-4">
          {/* Resumen del Step 1 */}
